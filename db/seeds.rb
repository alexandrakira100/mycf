...
User.destroy_all
Coin.destroy_all
user_one = User.create!(name: "Aki", email: "aki@test.com", password: "123456", photo: "aki.jpg")
user_two = User.create!(name: "Tim", email: "tim@test.com", password: "123456", photo: "tim.jpg")
user_three = User.create!(name: "Ammelie", email: "ammelie@test.com", password: "123456", photo: "ammelie.jpg")
user_four = User.create!(name: "Alex", email: "alex@test.com", password: "123456", photo: "alex.jpg")
